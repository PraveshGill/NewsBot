...
FB_ACCESS_TOKEN = "your fb page access token!!"
bot = Bot(FB_ACCESS_TOKEN)

VERIFICATION_TOKEN = "hello" #verification token when fb sends get request first to check!!
					...
					if messaging_event['message'].get('text'):
						...
						if query == "button":
							buttons = [{"type":"web_url",
										"url": "https://www.facebook.com/lets.do.bingo",
										"title":"My Profile"}]
